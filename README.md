...
Путь к входному JSON-файлу задается через переменную окружения `INPUT_JSON` (согласно заданию) или аргументом командной строки (в зависимости от реализации).
...
*   Отчет о покрытии кода (JaCoCo) можно найти здесь: `app/build/reports/jacoco/test/html/index.html`.
